...
class ViewApprovalTimelineAction extends Action
{
  protected function setUp(): void
  {
    ...
    $this->label(__('gatekeeper::approval_timeline_action.label'))
      ->slideOver()
      ->modal()
      ->modalIcon('fluentui-timeline-20')
      ->icon('fluentui-timeline-20')
      ->modalHeading(fn (Model $record) => __('gatekeeper::approval_timeline_action.modal_heading', ['id' => $record->id]))
      ...
      ->modalCancelActionLabel(__('gatekeeper::approval_timeline_action.modal_cancel_label'));
  }
}
