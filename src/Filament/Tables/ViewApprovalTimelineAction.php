...
class ViewApprovalTimelineAction extends Action
{
  protected function setUp(): void
  {
    ...
    $this->label(__('gatekeeper::gatekeeper.approval_timeline_action.label'))
      ...
      ->modalHeading(fn (Model $record) => __('gatekeeper::gatekeeper.approval_timeline_action.modal_heading', ['id' => $record->id]))
      ->modalContent(fn (Model $record) => view('gatekeeper::gatekeeper.components.activity-timeline', [
