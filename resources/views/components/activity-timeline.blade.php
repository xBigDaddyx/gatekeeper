<div class="space-y-6">
                ...
                <li class="p-4 bg-yellow-100 border-l-4 border-yellow-500 rounded">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xs text-gray-600">Requested by: {{ $approval->requested_by }}</p>
                        </div>
    ...
    <div>
        <h2 class="text-xl font-semibold">Approval History</h2>
            ...
            @foreach($approvalHistory as $history)
                <div class="relative">
                    ...
                    <div class="ml-6 p-4 bg-gray-100 rounded shadow">
                        ...
                        <p class="text-xs text-gray-600">Reviewed by: {{ $history->reviewed_by }} - <span class="font-bold">{{ ucfirst($history->status) }}</span></p>
